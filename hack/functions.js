...
function upgradeGovernor(num = 1) {
  for (let i = 0; i < num; i++) {
    document.querySelector("#root > div.MuiBox-root.css-1ik4laa > div.MuiBox-root.css-1mojy8p-root > div.MuiContainer-root.MuiContainer-maxWidthLg.MuiContainer-disableGutters.css-1orai50 > div.MuiPaper-root.MuiPaper-elevation.MuiPaper-rounded.MuiPaper-elevation1.css-wveda5 > div.MuiBox-root.css-70qvj9 > button").click();
    document.querySelector("body > div.MuiModal-root.css-34x829-modal > div.css-mdj4bq-paper > div > button").click();
    document.querySelector("body > div.MuiModal-root.css-34x829-modal > div.MuiBackdrop-root.MuiModal-backdrop.css-919eu4").click();
  }
}
...
function buyHacknetServers(clickTimes = 1) {
  const buyBtn = document.querySelector("#root > div.MuiBox-root.css-1ik4laa > div.MuiBox-root.css-1mojy8p-root > div.MuiGrid-root.MuiGrid-container.MuiGrid-spacing-xs-2.css-isbt42 > div:nth-child(1) > button");
